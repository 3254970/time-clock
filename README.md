...
מסמך זה מתמקד בהתקנה, פריסה והפעלה. לתיעוד טכני מלא של **ההתנהגות והלוגיקה
בפועל** - state machine של נוכחות, מודל נתונים מלא, מפת אחריות קבצים, וזרימות
כל מסך - ראו [SYSTEM_OVERVIEW.md](SYSTEM_OVERVIEW.md).
